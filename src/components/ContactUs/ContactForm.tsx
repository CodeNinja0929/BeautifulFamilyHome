            ...
            <div className="col-lg-7 col-md-12 ps-5">
              ...
              >
                <div className="title">
                  ...
                  <p>
                  Thank you for your interest in our rental property. Whether you have questions about the home, want to schedule a viewing, or need more information about the leasing process, we are here to assist you. Your satisfaction is our top priority, and we are committed to providing prompt and helpful responses to all your inquiries.
                  </p>
                </div>
