  ...
  return (
    <>
      ...
      <FsLightbox
        toggler={toggler}
        sources={[
          "https://www.youtube.com/watch?v=iL8xisaIy2Y",
        ]}
      />
      ...
      <div className="main-banner-area">
        <div className="container-fluid">
          <div className="main-banner-content">
            <h1
              ...
              data-aos-once="false"
            >
              BEAUTIFUL FAMILY HOME <span>FOR RENT </span>
            </h1>
            <p
              data-aos="fade-up"
              data-aos-delay="200"
              ...
              data-aos-once="false"
            >
              Welcome to 704 El Monte Rd El Cajon CA 92020.
            </p>
            <div 
        ...
        <ul className="main-banner-info">
          <li>
            <span>CALL:</span>
            <a href="tel:3214264567"> +1 (801) 783-1906 </a>
          </li>
          <li>
            <span>MAIL:</span>
            <a href="mailto:trazteam@gmail.com"> colinrico872@gmail.com </a>
          </li>
        </ul>
      </div>
    </>
